...
<head>
    ...
    <meta name="description"
        content="SmartTravel - Nhận diện tiền tệ AI, tỷ giá thời gian thực, bản đồ đổi tiền toàn cầu">
    ...
    @unless(View::hasSection('hide_navbar'))
        <nav class="navbar" id="main-navbar">
            ...
            <div class="nav-links">
                ...
                <a href="{{ route('scan') }}"
                    class="{{ request()->routeIs('scan') || request()->routeIs('result') ? 'active' : '' }}">
                    <i class="fa-solid fa-camera"></i> Quét tiền
                </a>
                <a href="{{ route('rates') }}" class="{{ request()->routeIs('rates') ? 'active' : '' }}">
                    <i class="fa-solid fa-chart-line"></i> Tỷ giá
                </a>
                <a href="{{ route('analysis') }}" class="{{ request()->routeIs('analysis') ? 'active' : '' }}">
                    <i class="fa-solid fa-microscope"></i> Thẩm định
                </a>
